...
**`CRM` arrived 2026-09-21** and is now **ten of thirty-four**, in two folders. `Admission
...
`Applications` holds four — #17 starts a form against an open cycle, #19 submits it, #24 reads the
pipeline back and #25 opens one form in full. The plan for the other twenty-four is in that
package's README.
...
**113 requests.** Counted 2026-09-22.
...
2026-09-22**, at 113 each — every CRM endpoint now has a screen. It is not a rule, though, and it
