...
**`Academics` arrived 2026-09-11** with the first eight endpoints of
...
**62 requests, and that is every endpoint that exists.** Checked rather than claimed: the
...
**Academics is 8 of 36** — create a class, edit it, add a section, add a subject, edit one,
list the year's classes, read one class in full, read its sections. The other twenty-eight are
specified in
