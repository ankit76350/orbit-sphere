package com.orbitastra.backend.controllers.people.department;
...
import com.orbitastra.backend.services.people.DepartmentService;
...
public class DepartmentController {
    ...
    public ResponseEntity<PositionResponse> createPosition(
        ...
        PositionResponse response = departmentService.createPosition(request);
        return ResponseEntity
    ...
    public ResponseEntity<PositionResponse> updatePosition(@PathVariable String id,
        ...
        return ResponseEntity.ok(departmentService.updatePosition(id, request));
    }
    ...
    public ResponseEntity<Object> listDepartments(DepartmentSearchRequest request) {
        ...
        if (Boolean.TRUE.equals(request.tree())) {
            ...
            return ResponseEntity.ok(departmentService.treeOfDepartments(request));
        }

        PageResponse<?> page = departmentService.listDepartments(request);
    ...
    public ResponseEntity<PageResponse<PositionRowResponse>> listPositions(
        ...
        return ResponseEntity.ok(departmentService.listPositions(request));
    }
    ...
    public ResponseEntity<PositionDetailResponse> getPosition(@PathVariable String id) {
        return ResponseEntity.ok(departmentService.getPosition(id));
    }
}
