...
| **[`crm`](crm/README.md)** | ✅ | **5 controllers · 28 of 33 endpoints, plus #27b, #27c, #27d and #29b** |
...
**A ~~struck~~ number is built.** Twenty-eight of `crm`'s thirty-three — #11 was removed on
