...
| **[`crm`](crm/README.md)** | ✅ | **5 controllers · 26 of 34 endpoints, plus #27b, #27c, #27d and #29b** |
...
**A ~~struck~~ number is built.** Twenty-six of `crm`'s thirty-four — plus four lettered verbs the
...
**Phase 9 can be read and corrected, but not worked.** [`crm` #8](crm/README.md#e8) captures a
lead, [#13](crm/README.md#e13) lists them, [#14](crm/README.md#e14) opens one and
[#9](crm/README.md#e9) fixes what the desk misheard — but nothing logs a call, hands a lead to a
counsellor or marks one lost. Every lead in the system reads `NEW` with an empty timeline.
