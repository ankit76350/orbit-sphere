...
| **[`crm`](crm/README.md)** | ✅ | **2 controllers · 9 of 34 endpoints** |
...
**A ~~struck~~ number is built.** Nine of `crm`'s thirty-four and none of `student`'s
twenty-two — phase 1 complete, phase 2 all but [`crm` #19](crm/README.md#e19), and the two
