...
The sketch in `undone/a_new/transport/TransportTelemetryPoint` already assumed a
time-series collection. That instinct was right; it just does not belong in the
same design pass.
