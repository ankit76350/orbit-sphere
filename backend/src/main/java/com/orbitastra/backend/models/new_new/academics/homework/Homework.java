...
import com.orbitastra.backend.models.new_new.academics.enums.HomeworkScope;
import com.orbitastra.backend.models.new_new.academics.enums.HomeworkStatus;
...
@CompoundIndexes({
        @CompoundIndex(
                ...
                def = "{'schoolId': 1, 'academicYear': 1, 'classDocsId': 1, 'sectionDocsId': 1, 'status': 1, 'dueAt': 1}"),
        @CompoundIndex(
...
public class Homework extends SchoolBase {
    ...
    // Links to ClassSection.id when the assignment is section-specific.
