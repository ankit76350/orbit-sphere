package com.orbitastra.backend.dto.plans.plandefinition.response;
 ...
 *
 * <p>The rows are {@link PlanFeatureResponse}, shared with #10 — one shape for a feature however it
 * is asked for.
 *
