...
export default function ModAdmission({ user }) {
  ...
  const [dob, setDob] = useState("2015-06-19");
  const [parentName, setParentName] = useState("Priya Sharma");
  const [parentPhone, setParentPhone] = useState("+61-400-555-666");
  const [parentEmail, setParentEmail] = useState("priya@example.com");
  const [address, setAddress] = useState("9 Oak Ave, Tech City");
