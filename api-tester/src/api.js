...
export const api = {
  ...
  addSubject: (classDocsId, payload) => call('POST', `/api/classes/${classDocsId}/subjects`, payload),
  addSections: (classDocsId, sections) => call('POST', `/api/classes/${classDocsId}/sections`, { section: sections }),
