        ...
        submodules: [
          {
            ...
            // Seven: the whole cycle half of the module — #1 creates a round, #2 corrects one,
            // #3 moves its status, #4 sets its seats, #5 lists them, #6 opens one, and #7 counts
            // the seats against the applications. It came last because it needed applications to
            // exist, and then offers, to have anything to count.
            endpoints: 7,
          ...
          },
          {
            ...
            label: 'Inquiries',
            group: 'CRM / Inquiries',
            // Four: #8 captures a lead, #13 is the counsellor's worklist, #14 opens one with its
            // timeline and #9 corrects it. The screen had NO LIST until #13 existed and said so,
            // rather than drawing an empty table — now the table is real. #10 to #12, #15 and #16
            // are still not built, which is why every row reads NEW with nobody promising to ring.
            endpoints: 4,
            screen: Inquiries,
          ...
          },
          {
            ...
            label: 'Offers',
            group: 'CRM / Offers',
            // One: #32. #29 issues, #29b corrects, #30 answers and #31 withdraws — all four
            // live on the application's own page, where its single offer letter is, so they are
